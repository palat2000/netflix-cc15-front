...
export const getChooseProfileAccessToken = () =>
  localStorage.getItem(CHOOSE_PROFILE_ACCESS_TOKEN);
export const removeChooseProfileAccessToken = () =>
  localStorage.removeItem(CHOOSE_PROFILE_ACCESS_TOKEN);
